    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">智能记账与理财</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 记账分类与精细理财诊断</span>
...
// 清理回复末尾的特殊标记 [JIZHANG_SCORES]...[/JIZHANG_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[JIZHANG_SCORES\][\s\S]*?\[\/JIZHANG_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 记账账单与理财分析】\n\n${cleanContent.value}\n\n体验科学记账理财大模型：https://ai.wuxian.xyz`;
